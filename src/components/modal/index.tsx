...
export const Modal = (props: ModalProps) => {
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="tw_fixed tw_z-10 tw_inset-0 tw_overflow-y-auto" initialFocus={cancelButtonRef} onClose={() => setOpen(false)}>
                <div className="tw_flex tw_items-end tw_justify-center tw_min-h-screen tw_pt-4 tw_px-4 tw_pb-20 tw_text-center sm:tw_block sm:tw_p-0">
                    ...
                    >
                        <div className={`${props.className} modal-content tw_inline-block tw_align-bottom tw_bg-white tw_rounded-lg tw_text-left tw_overflow-hidden tw_shadow-xl tw_transform tw_transition-all sm:tw_my-8 sm:tw_align-middle tw sm:tw_w-full`}>                            
                            {/* title */}
                            { useHeader 
                            ...
                            {/* footer */}
                            {useFooter
                                ?   <div className={`tw_justify-${footerPosition} sm:tw_justify-center tw_flex tw_w-full tw_bottom-0 tw_absolute tw_bg-gray-50 tw_px-4 tw_py-3 sm:tw_px-6 sm:tw_flex sm:tw_flex-row-reverse`}>
                                        {footer}
                                    </div>
                                : null
                            }
